...
app.post('/analyze-and-generate', upload.single('photo'), async (req, res) => {
  console.log('Received request to analyze and generate image');
  try {
    if (!req.file) {
...
[generated image]`;
    ...
    console.log('Found generated image data, size:', generatedImageData.length, 'characters');
    console.log('Generated title:', socialMediaTitle);
    ...
    console.log('Image merge completed, final size:', mergedImageBase64.length, 'characters');
